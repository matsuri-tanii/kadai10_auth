...
// SQL作成
$sql = 'INSERT INTO records (record_date, record_time, record_type, nickname, weather, body_condition, mental_condition, want_to_do, memo, created_at, updated_at, user_id)
        VALUES (:record_date, :record_time, :record_type, :nickname, :weather, :body, :mental, :want_to_do, :memo, :created_at, :updated_at, :user_id)';
